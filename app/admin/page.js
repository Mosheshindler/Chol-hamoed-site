...
export default function AdminPage(){
  ...
  function editVideo(v){
    setForm({...emptyForm,...v,categories:(Array.isArray(v.categories)&&v.categories.length?v.categories:[v.category].filter(Boolean)),tags:(Array.isArray(v.tags)?v.tags:[]),duration_seconds:v.duration_seconds??''});setThumbFile(null);setHeroFile(null);setMessage('Editing video.');window.scrollTo({top:0,behavior:'smooth'})
  }
