...
const emptyForm={id:null,title:'',slug:'',video_url:'',platform:'vimeo',vimeo_hash:'',client:'Mint Media',category:'Behind the Scenes',categories:['Behind the Scenes'],thumbnail_url:'',hero_image_url:'',duration_seconds:'',featured:false,premium:false,purchase_url:'',published:true,sort_order:0}
  ...
  async function saveVideo(e){
    ...
    try{
      ...
      const payload={
        ...
        client:form.client?.trim()||null,category:(form.categories?.[0]||form.category||null),categories:(form.categories?.length?form.categories:[form.category].filter(Boolean)),thumbnail_url:thumbnail||null,hero_image_url:heroImage,
