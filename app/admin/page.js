...
const emptyForm={id:null,title:'',slug:'',video_url:'',platform:'vimeo',vimeo_hash:'',client:'Mint Media',category:'Behind the Scenes',categories:['Behind the Scenes'],tags:[],thumbnail_url:'',hero_image_url:'',duration_seconds:'',featured:false,show_just_minted:true,premium:false,purchase_url:'',published:true,sort_order:0}
  ...
  async function saveVideo(e){
    ...
    try{
      ...
      const payload={
        ...
        duration_seconds:form.duration_seconds===''?null:Number(form.duration_seconds),featured:Boolean(form.featured),show_just_minted:Boolean(form.show_just_minted),premium:Boolean(form.premium),purchase_url:form.premium?(form.purchase_url?.trim()||null):null,published:Boolean(form.published),sort_order:Number(form.sort_order)||0
      }
