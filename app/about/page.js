...
export default function About(){return <><Header/><main className="aboutPage">
  <section className="aboutHero"><div className="aboutShell aboutHeroInner"><div><div className="eyebrow">ABOUT MINT MEDIA</div><h1>Stories<br/>That Matter</h1><p>We believe in the power of video to inform, inspire, and create real impact.</p></div></div></section>
  <section className="aboutShell aboutStats"><div><StatIcon type="calendar"/><small>Since</small><strong>2014</strong></div><div><StatIcon type="team"/><small>A Team of</small><strong>11</strong></div><div><StatIcon type="event"/><small>Annual Events</small><strong>50K+</strong><small>Attendees</small></div><div><StatIcon type="eye"/><small>One Video</small><strong>200K+</strong><small>Views</small></div></section>
  <section className="aboutShell aboutStory"><div className="aboutStoryCopy"><div className="eyebrow">OUR STORY</div><h2>A Passion for<br/>Meaningful Video</h2><p>Mint Media was founded in 2014 in Lakewood, NJ with a simple idea — to use the power of video to share important stories and make a positive impact.</p><p>What started as a small, passionate team has grown into a full-service video production company, creating videos for large-scale events, organizations, businesses, and individuals.</p><p>We’re grateful for the opportunity to do what we love every day.</p></div><div className="aboutChair" aria-hidden="true"/></section>
