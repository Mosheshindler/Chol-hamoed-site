...
export default function Contact(){return <><Header/><main className="contactPage">
  <section className="contactHero"><div className="contactShell contactHeroInner"><div className="eyebrow">CONTACT US</div><h1>Let’s<br/>Connect</h1><i></i><p>WE’D LOVE TO HEAR FROM YOU</p></div></section>
