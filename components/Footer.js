...
</div><div className="wide footerLegal"><span>© 2026 Mint Media. All rights reserved.</span><Link href="/privacy" className="footerSafetyLink">Privacy Policy</Link></div></footer>}
