...
export default function Footer(){return <footer className="footer"><div className="wide footerInner">
  ...
  <nav className="footerNav"><Link href="/">Home</Link><Link href="/category/all-videos">Categories</Link><Link href="/collections">Collections</Link><Link href="/category/all-videos">All Videos</Link><Link href="/about">About</Link><Link href="/contact">Contact</Link></nav>
...
</div><div className="wide footerLegal"><span>© 2026 Mint Media. All rights reserved.</span><div className="footerLegalLinks"><Link href="/privacy" className="footerSafetyLink">Privacy Policy</Link><Link href="/safety" className="footerSafetyLink">Safety &amp; Content Policies</Link></div></div></footer>}
