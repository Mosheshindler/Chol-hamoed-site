...
</div><div className="wide footerLegal"><span>© 2026 Mint Media. All rights reserved.</span><div className="footerLegalLinks"><Link href="/privacy" className="footerSafetyLink">Privacy Policy</Link><Link href="/safety" className="footerSafetyLink">Content Standards</Link></div></div></footer>}
